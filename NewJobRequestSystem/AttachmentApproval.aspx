<%@ Page Title="" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="AttachmentApproval.aspx.cs" Inherits="NewJobRequestSystem.AttachmentApproval" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_panel" runat="server" id="divRecords" visible="true">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Uploading Attachments</h2>
        ...
        <div class="x_content">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gridRecords" runat="server" CssClass="RadGrid" GridLines="None"
                ...
                AllowAutomaticUpdates="True" DataSourceID="getRecords" Width="100%" OnItemDataBound="gridRecords_ItemDataBound">
                ...
                <MasterTableView DataSourceID="getRecords" DataKeyNames="Jr_Code" AllowFilteringByColumn="true">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="DateApproved" HeaderText="Date Approve" 
                            DataField="NewApproveDate" AllowFiltering="false">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn UniqueName="Status" HeaderText="Status" DataField="AttachmentStat"
                            FilterControlWidth="100%" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                        </telerik:GridBoundColumn>

                        <telerik:GridTemplateColumn UniqueName="action" 
                            FilterControlWidth="100%" AutoPostBackOnFilter="true" AllowFiltering="false">
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn 
                            UniqueName="AttachmentStat" CurrentFilterFunction="Contains" FilterControlWidth="100%" Display="false" AllowFiltering="false">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="txtRR" Text='<%# Eval("AttachmentStat")%>'></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

                        <telerik:GridTemplateColumn HeaderStyle-Width="100px" ItemStyle-Width="100px" 
                            UniqueName="lnkResendRequest"  AllowFiltering="false"
                            ItemStyle-HorizontalAlign="Center" 
                            HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkResendRequest" runat="server" class="aligncenter btn btn-primary" Text="Resend" Style="color: white;"
                                    CommandArgument='<%# Eval("Jr_Code")%>' OnClientClick="return confirm('Do you want to resend the request?')" OnClick="lnkResend_Click" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
    ...
    <div class="x_panel" runat="server" id="divDetails" visible="false">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Uploading Attachments - Details</h2>
            <ul class="nav navbar-right panel_toolbox">
                <li>
        ...
        <div class="x_content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div style="text-align: right">
                                            <telerik:RadCheckBox runat="server" ID="RadCheckBox1" Text="Check If No Attachment Needed" AutoPostBack="false" />
                                        </div>
                                    </div>
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" ID="gridAttachment2" GridLines="None" EnableLinqExpressions="false"
                                    ...
                                    <MasterTableView CommandItemDisplay="None" DataKeyNames="id" AllowFilteringByColumn="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="PreparedBy" HeaderText="Prepared By"
                                                AllowFiltering="true" FilterControlWidth="100%" ShowFilterIcon="false"
                                                AutoPostBackOnFilter="true" FilterCheckListEnableLoadOnDemand="true"
                                                SortExpression="PreparedBy" CurrentFilterFunction="Contains" UniqueName="PreparedBy" />

                                            <telerik:GridBoundColumn DataField="CheckedBy" HeaderText="Checked By"
                                                AllowFiltering="true" FilterControlWidth="100%" ShowFilterIcon="false"
                                                AutoPostBackOnFilter="true" FilterCheckListEnableLoadOnDemand="true"
                                                SortExpression="CheckedBy" CurrentFilterFunction="Contains" UniqueName="CheckedBy" />

                                            <telerik:GridBoundColumn DataField="ApprovedBy" HeaderText="Approved By"
                                                AllowFiltering="true" FilterControlWidth="100%" ShowFilterIcon="false"
                                                AutoPostBackOnFilter="true" FilterCheckListEnableLoadOnDemand="true"
                                                SortExpression="ApprovedBy" CurrentFilterFunction="Contains" UniqueName="ApprovedBy" />
            ...
            <div class="row">
                <div class="col-lg-12 aligncenter">
                    <%--<asp:ImageButton ID="btnaccept" CssClass="btnview" OnClientClick="return confirm('Accept Request?');"
                        runat="server" ImageUrl="images/accept.bmp" Width="150px" Height="50px" OnClick="btnaccept_Click"></asp:ImageButton>--%>
                    <telerik:RadButton ID="btnSubmit" runat="server"
                        Text="Send To Next Approver" SingleClick="true"
                        Primary="true" RenderMode="Lightweight" Enabled="true"
                        Style="width: 150px; height: 38px; margin-top: 30px"
                        SingleClickText="Processing..." OnClick="btnaccept_Click">
                ...
                <div class="row" style="padding: 5px;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <table style="border: none; width: 100%">
                            ...
                            <tr>
                                <td style="border: none; text-align: center; width: 16%">
            ...
            <asp:SqlDataSource ID="SQLDSGetAttachment" runat="server"
                SelectCommand="Select * from tblAttachment where RTRIM(LTRIM(JR_Code)) = @JR_Code and RTRIM(LTRIM(typeofattachment)) = 'User'"
            ...
            <asp:SqlDataSource ID="SQLDSGetAttachment2" runat="server"
                SelectCommand="Select * from tblAttachment where RTRIM(LTRIM(JR_Code)) = @JR_Code and RTRIM(LTRIM(typeofattachment)) = 'Admin'"
                SelectCommandType="Text">
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        ...
        if @incharge != '05' 
	        begin
                ...
                FORMAT (A.DateApproved, 'dd/MMM/yyyy') NewApproveDate,
				...
				AttachmentStat = case when a.AttachementStatus is null then 'FOR UPLOADING OF ATTACHMENT'
				WHEN A.AttachementStatus = 'PREPARED' THEN 'FOR ATTACHMENT CHECKING'
				WHEN A.AttachementStatus = 'NOTED' THEN 'FOR ATTACHMENT APPROVAL' END        
                ...
                and A.Is_Assessed = 1 and A.Is_Noted = 1 and A.Is_Approved = 1 and A.Is_JobAccepted = 1 and A.Is_AttachmentApproved = 0
                and (A.IsRejected = 0 or A.IsCancelled = 0) and 
                A.Incharge_ID != '05' and Year(A.Request_Date) = @Year

                order by case when (case when a.AttachementStatus is null then 'FOR UPLOADING OF ATTACHMENT'
				WHEN A.AttachementStatus = 'PREPARED' THEN 'FOR ATTACHMENT CHECKING'
				WHEN A.AttachementStatus = 'NOTED' THEN 'FOR ATTACHMENT APPROVAL' END) !=  'FOR UPLOADING OF ATTACHMENT' then 1 else 2 end
	        end
        else
		    begin
		        Select 
                ...
                order by A.Request_Date desc,case when (case when a.AttachementStatus is null then 'FOR UPLOADING OF ATTACHMENT'
				WHEN A.AttachementStatus = 'PREPARED' THEN 'FOR ATTACHMENT CHECKING'
				WHEN A.AttachementStatus = 'NOTED' THEN 'FOR ATTACHMENT APPROVAL' END) !=  'FOR UPLOADING OF ATTACHMENT' then 1 else 2 end
		    end"
        SelectCommandType="Text">
        ...
        <SelectParameters>
            ...
            <asp:QueryStringParameter Name="Year" QueryStringField="RequiredYear" Type="Int32" />
