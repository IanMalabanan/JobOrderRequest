<%@ Page Title="" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="UserForChecking.aspx.cs" Inherits="NewJobRequestSystem.UserForChecking" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
                            ...
                            <tr runat="server" id="divNoterShowProcessing">
                                <td colspan="6">
                                    <div>
                                        ...
                                        <%--<div class="x_title" style="background-color: rgb(0,128,255);">

                                            <div class="row">

                                                <table style="border: none; margin-left: 10px; margin-top: 5px">
                                                    <tr>
                                                        <td style="width: 50px; text-align: center">
                                                            <i class="fa fa-hourglass-2" style="color: white; margin-top: 2px; font-size: 25px; margin-right: 15px"></i>
                                                        </td>
                                                        <td>
                                                            <h3 style="color: white">For Noting</h3>
                                                        </td>
                                                    </tr>
                                                </table>
