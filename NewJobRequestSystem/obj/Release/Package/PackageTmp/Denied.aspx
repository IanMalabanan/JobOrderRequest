<%@ Page Title="" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="Denied.aspx.cs" Inherits="NewJobRequestSystem.Denied" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        ...
        if @incharge != '05' 
	        begin
                ...
                where (A.IsRejected = 1 or A.IsCancelled = 1) and A.Incharge_ID != '05' 	
	        end
        else
