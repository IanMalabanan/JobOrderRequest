<%@ Page Title="" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="OnGoingJobOrder.aspx.cs" Inherits="NewJobRequestSystem.OnGoingJobOrder" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
                ...
                <MasterTableView DataSourceID="getRecords" DataKeyNames="Jr_Code">
                    ...
                    <Columns>
                        ...
                        <telerik:GridCheckBoxColumn DataField="Counters" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" 
                                            HeaderText="Has Attachment?"  UniqueName="Counters" />
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        ...
        if @incharge != '05' 
	        begin
                ...
                and A.Is_Assessed = 1 and A.Is_Noted = 1 and A.Is_Approved = 1 and A.IsJobAccepted = 1 and A.IsCompleted = 0
		    ...
		    begin                
                ...
                where 
                A.Is_Submitted = 1 and A.Is_Checked = 1 
                and A.Is_Assessed = 1 and A.Is_Noted = 1 and A.Is_Approved = 1 and A.Is_JobAccepted = 1 and A.IsCompleted = 0
                and (A.IsRejected = 0 or A.IsCancelled = 0) and 
                A.Incharge_ID = '05'
		    end"
