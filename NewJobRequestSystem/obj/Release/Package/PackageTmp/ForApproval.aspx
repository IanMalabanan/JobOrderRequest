<%@ Page Title="" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="ForApproval.aspx.cs" Inherits="NewJobRequestSystem.ForApproval" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        ...
        if @incharge != '05' 
	        begin
                ...
                and (A.IsRejected = 0 or A.IsCancelled = 0) and A.Incharge_ID != '05' 	
	        end
        else
