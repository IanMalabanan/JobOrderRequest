<%@ Page Title="" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="PendingJobOrder.aspx.cs" Inherits="NewJobRequestSystem.PendingJobOrder"
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        ...
        if @incharge != '05' 
	        begin
                ...
                and A.Is_Assessed = 1 and A.Is_Noted = 1 and A.Is_Approved = 1 and A.IsJobAccepted = 0
