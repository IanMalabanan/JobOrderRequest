<%@ Page Title="" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="ForChecking.aspx.cs" Inherits="NewJobRequestSystem.ForChecking" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        ...
        if @incharge != '05' 
	        begin
                ...
                where A.Is_Submitted = 1 and A.Is_Checked = 0 and (A.IsRejected = 0 or A.IsCancelled = 0) and A.Incharge_ID != '05' 	
	        end
        else
