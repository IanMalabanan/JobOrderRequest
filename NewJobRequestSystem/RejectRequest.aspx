<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectRequest.aspx.cs" Inherits="NewJobRequestSystem.RejectRequest" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row" style="margin-left:2px;margin-right:2px;">
            ...
            <div class="col-12">
                ...
                <asp:TextBox ID="tbRejectReasons" style="margin-top:5px" runat="server" ReadOnly="false" placeholder="Enter Text Here..." CssClass="form-control" Height="180px" TextMode="MultiLine"></asp:TextBox>
        ...
        <div class="row" style="margin-left:2px;margin-right:2px">
            ...
            <div class="col-12">
                ...
                <telerik:RadButton ID="btnReject" runat="server" Style="height: 35px;"
                    Text="Reject" SingleClick="true" Width="100px" Primary="true" RenderMode="Lightweight"
