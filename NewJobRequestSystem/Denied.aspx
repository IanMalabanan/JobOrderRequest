<%@ Page Title="Denied and Cancelled" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="Denied.aspx.cs" Inherits="NewJobRequestSystem.Denied" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_panel" runat="server" id="divRecords" visible="true">
        <div class="x_title">
            <h2 style="margin-top: 8px">Denied / Cancelled Requests</h2>
    ...
    <div class="x_panel" runat="server" id="divDetails" visible="false">
        <div class="x_title">
            <h2 style="margin-top: 8px">Denied / Cancelled Request - Details</h2>
            <ul class="nav navbar-right panel_toolbox"  >
                <li>
        ...
        <div class="x_content">
            ...
            <div class="row" runat="server" id="rowCancelled" visible="false">

                <div class="col-lg-12">

                    <div class="alert alert-info" role="alert">

                        <asp:Label runat="server" ID="lblCancelled" Text="This request has been cancelled by the requestor." Font-Size="Medium"></asp:Label>
                    </div>
            ...
            <div class="row" runat="server" id="rowRejected" visible="false">

                <div class="col-lg-12">

                    <div class="alert alert-danger" role="alert">

                        <asp:Label runat="server" ID="lblRemarks" Font-Size="Medium" style="color:white"></asp:Label>
                    </div>
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        SelectCommand="   
		    begin
                ...
                where (A.IsRejected = 1 or A.IsCancelled = 1) and Year(A.Request_Date) = @Year
		    end" SelectCommandType="Text">
