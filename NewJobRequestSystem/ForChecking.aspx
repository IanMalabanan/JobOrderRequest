<%@ Page Title="For Checking" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="ForChecking.aspx.cs" Inherits="NewJobRequestSystem.ForChecking" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <telerik:RadScriptBlock runat="server">
        <script type="text/javascript">
            function ShowChangeApproverForm(code, action) {
                window.radopen("ChangeApprover.aspx?RCode=" + code + "&Role=" + action, "ChangeApprover");
                return false;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true">
        <Windows>
            ...
            <telerik:RadWindow RenderMode="Lightweight" ID="ChangeApprover" runat="server" Title="Change Approver"
                Width="500px" Height="300px" VisibleStatusbar="false" VisibleTitlebar="true" ReloadOnShow="true"
                ShowContentDuringLoad="false" Behaviors="Close" Modal="true" Skin="WebBlue">
            </telerik:RadWindow>
        </Windows>
    </telerik:RadWindowManager>

    <%--  <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager2" runat="server" EnableShadow="true" Behaviors="Close" Title="Change Approver"
        CenterIfModal="true" Skin="WebBlue" Width="500px" Height="300px" Modal="true" VisibleStatusbar="false" VisibleTitlebar="true" ReloadOnShow="true">
        <Windows>
    ...
    <div class="x_panel" runat="server" id="divRecords" visible="true">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Checking</h2>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gridRecords" runat="server" CssClass="RadGrid" GridLines="None"
                ...
                <MasterTableView DataSourceID="getRecords" DataKeyNames="Jr_Code" AllowFilteringByColumn="true">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="Requestedby" HeaderText="Requested by" DataField="FullName_FnameFirst" FilterControlWidth="100%" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn UniqueName="Requestdate" HeaderText="Date Request" DataField="NewDate" AllowFiltering="false">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn UniqueName="Dept_Desc" HeaderText="Department" DataField="Dept_Desc" FilterControlWidth="100%" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn UniqueName="Sect_Desc" HeaderText="Section" DataField="Sect_Desc" FilterControlWidth="100%" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                        </telerik:GridBoundColumn>
    ...
    <div class="x_panel" runat="server" id="divDetails" visible="false">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Checking - Details</h2>
            <ul class="nav navbar-right panel_toolbox">
                <li>
                ...
                <div class="row" style="padding: 5px;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <table style="border: none; width: 100%">
                            ...
                            <tr runat="server" id="divNoterShowProcessing">
                                <td colspan="6">
                                    <div>
                                        <div class="x_content">
                                            ...
                                            <table style="width: 100%; border: none">
                                                <tr>
                                                    <td>
                                                        <telerik:RadButton ID="btnResendToCurrent" runat="server"
                                                            Text="Resend" SingleClick="true" CssClass="bounce pull-right"
                                                            ...
                                                            SingleClickText="Processing..." OnClick="Resend">
                                                        </telerik:RadButton>
                                                    </td>
                                                    <td>
                                                        <telerik:RadButton ID="btnCancel" runat="server"
                                                            Text="Cancel" SingleClick="true" CssClass="bounce pull-left"
                                                            Primary="true" RenderMode="Lightweight"
                                                            Style="width: 100px; height: 38px; margin-left: 5px;"
                                                            OnClientClick="return confirm('By clicking Yes/OK will submit the Request. Do you want to proceed?')"
                                                            SingleClickText="Processing..." OnClick="Cancel">
                                                        </telerik:RadButton>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" class="aligncenter">
                                                        <a runat="server" id="btnChangeNoter" class="btn btn-primary"
                                                            style="width: 150px; height: 38px; font-size: 15px; font-weight: 400">Change Approver</a>
                                                    </td>
                                                </tr>
                                            </table>
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        SelectCommand="      
            begin
                ...
                where A.Is_Submitted = 1 and A.Is_Checked = 0 and A.IsRejected = 0 and A.IsCancelled = 0

                and Year(A.Request_Date) = @Year
