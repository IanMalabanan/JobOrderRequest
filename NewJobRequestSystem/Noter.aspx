<%@ Page Title="Noter" Language="C#" MasterPageFile="~/Signatories.Master" AutoEventWireup="true" CodeBehind="Noter.aspx.cs" Inherits="NewJobRequestSystem.Noter" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="card" runat="server" id="divApplication">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-3" runat="server" id="Div1">
                ...
                <div class="col-6" runat="server" id="colAssessRemarks">
