<%@ Page Title="For Approval" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="ForApproval.aspx.cs" Inherits="NewJobRequestSystem.ForApproval" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_panel" runat="server" id="divRecords" visible="true">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Approval</h2>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gridRecords" runat="server" CssClass="RadGrid" GridLines="None"
                ...
                <MasterTableView DataSourceID="getRecords" DataKeyNames="Jr_Code" AllowFilteringByColumn="true">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="Problem_Desc" HeaderText="Justification" DataField="Problem_Desc" CurrentFilterFunction="Contains" FilterControlWidth="100%" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                        </telerik:GridBoundColumn>
    ...
    <div class="x_panel" runat="server" id="divDetails" visible="false">
        ...
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Approval - Details</h2>
            <ul class="nav navbar-right panel_toolbox">
                <li>
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        SelectCommand="begin
                ...
                and A.Is_Assessed = 1 and A.Is_Noted = 1 and A.Is_Approved = 0
