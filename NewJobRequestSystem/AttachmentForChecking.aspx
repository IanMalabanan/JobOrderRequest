<%@ Page Title="Noter" Language="C#" MasterPageFile="~/Signatories.Master" AutoEventWireup="true" CodeBehind="AttachmentForChecking.aspx.cs" Inherits="NewJobRequestSystem.AttachmentForChecking"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="card-body">
            ...
            <div class="row" runat="server" id="rowCommandButtonsOnly">
                ...
                <div class="col-12 aligncenter">
                    ...
                    <%--<button type="button" id="Button2" runat="server" class="btn btn-warning btn-flat"
                        style="width: 200px; height: 38px; margin-left: 10px; margin-right: 10px;"
                        data-toggle="modal" data-target="#modalPendingRemarks">
                        Hold and Leave Message</button>--%>

                    <a runat="server" id="btnShowHold" class="btn btn-warning"
                        style="width: 200px; height: 38px; margin-left: 10px; margin-right: 10px;">Hold and Leave Message</a>
    ...
    <div class="card" runat="server" id="divCancelled" visib
        le="false">
