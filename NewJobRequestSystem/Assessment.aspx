<%@ Page Title="Assessment" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="Assessment.aspx.cs" Inherits="NewJobRequestSystem.Assessment" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_panel" runat="server" id="divRecords" visible="true">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Assessment</h2>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gridRecords" runat="server" CssClass="RadGrid" GridLines="None"
                ...
                <MasterTableView DataSourceID="getRecords" DataKeyNames="Jr_Code" AllowFilteringByColumn="true">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="Requestdate" HeaderText="Date Request" DataField="NewDate" 
                        ...
                        <telerik:GridBoundColumn UniqueName="Sect_Desc" HeaderText="Section" DataField="Sect_Desc" CurrentFilterFunction="Contains" 
    ...
    <div class="x_panel" runat="server" id="divDetails" visible="false">
        <div class="x_title">
            <h2 style="margin-top: 8px">Job Request Details</h2>
            <ul class="nav navbar-right panel_toolbox">
                <li>
        ...
        <div class="x_content">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <asp:DropDownList ID="ddlAssessment" runat="server" CssClass="form-control" AutoPostBack="true" Height="39px" DataTextField="Assessment" DataValueField="AssessmentCode"
                        OnSelectedIndexChanged="ddlAssessment_SelectedIndexChanged">
                    </asp:DropDownList>
                </div>
            ...
            <div class="row">
                <div class="col-lg-10" runat="server" id="colAssessRemarks">
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        SelectCommand="        
            ...
            begin
                ...
                ,(RTRIM(c.FirstName) + ' ' + RTRIM(c.LastName)) as FullName_FnameFirst
                ...
                where A.Is_Submitted = 1 and A.Is_Checked = 1 and A.Is_Assessed = 0 and A.IsRejected = 0 and A.IsCancelled = 0
