<%@ Page Title="Requestor's Acceptance / Completed" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="Completed.aspx.cs" Inherits="NewJobRequestSystem.Completed" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_panel" runat="server" id="divRecords" visible="true">
        <div class="x_title">
            <h2 style="margin-top: 8px">Requestor's Acceptance / Completed Records</h2>
        ...
        <div class="x_content">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gridRecords" runat="server" CssClass="RadGrid" GridLines="None"
                ...
                OnItemDataBound="gridRecords_ItemDataBound">
    ...
    <div class="x_panel" runat="server" id="divDetails" visible="false">
        <div class="x_title">
            <h2 style="margin-top: 8px">Completed Records - Details</h2>
            <ul class="nav navbar-right panel_toolbox">
                <li>
        ...
        <div class="x_content">
            ...
            <%--<div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <label class="docconlabels">Employees Remarks:</label>

                    <asp:TextBox runat="server" ID="tbEmpRemarks" ReadOnly="true" CssClass="form-control" Width="100%" TextMode="MultiLine" Height="150px" placeholder="Enter Text Here..."></asp:TextBox>
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        ...
        IF OBJECT_ID('TEMPDB.dbo.#tblCountAttachment') IS NOT NULL DROP TABLE #tblCountAttachment
	        ...
	        begin
                ...
                and A.IsRejected = 0 and A.IsCancelled = 0 and 
