<%@ Page Title="Completed" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="UserCompleted.aspx.cs" Inherits="NewJobRequestSystem.UserCompleted" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_panel" runat="server" id="divDetails">
        ...
        <div class="x_content">
            ...
            <div class="row" id="rowRemarks" runat="server">

                <div class="col-lg-12">

                    <label class="docconlabels">Employees Remarks Before Accepting:</label>

                    <asp:TextBox runat="server" ID="tbEmpRemarks" CssClass="form-control" Width="100%" TextMode="MultiLine" Height="150px" placeholder="Enter Text Here..."></asp:TextBox>

                    <br />

                    <asp:Button runat="server" ID="btnSendRemarks" CssClass="btn btn-primary btn-block pull-right"  
                        OnClick="btnSendRemarks_Click" Width="160px" Text="Send To Assesstor"/>
                    ...
                    <div class="col-lg-12">
                        ...
                        <table style="border: none; width: 100%">
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid black; text-align: center; width: 16%">
                                    <div runat="server" id="rowReceiverRemarks">
                                    ...
                                    <asp:ImageButton ID="btnaccept" CssClass="btnview" OnClientClick="return confirm('Accept?');"
                                        runat="server" ImageUrl="images/accept2.png" Width="150px" Height="50px" 
                                        OnClick="btnaccept_Click" Visible="false"></asp:ImageButton>
                                    <p><i>(Requestor)</i></p>
