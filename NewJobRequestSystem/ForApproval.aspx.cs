    ...
    public partial class ForApproval : System.Web.UI.Page
    {
        ...
        private void GetRequestDetails()
        {
            ...
            foreach (DataRow row in ConvertToDataTable(a).Rows)
            {
                ...
                isChecked = Convert.ToBoolean(row[31]);
        ...
        private void SendEmailToApprover(string EmpID, string UniqueCode, string EmailAdd)
        {
            string body;
            ...
            body += "<br /><br />" + "http://" + HttpContext.Current.Request.Url.Authority + "/"
                     + ConfigurationManager.AppSettings["ApproverPage"] + "?EmpID=" + EmpID.Trim() + "&RCode=" + UniqueCode.Trim();
