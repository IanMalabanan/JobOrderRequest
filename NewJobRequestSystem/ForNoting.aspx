<%@ Page Title="For Noting" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="ForNoting.aspx.cs" Inherits="NewJobRequestSystem.ForNoting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_panel" runat="server" id="divRecords" visible="true">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Noting</h2>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gridRecords" runat="server" CssClass="RadGrid" GridLines="None"
                ...
                <MasterTableView DataSourceID="getRecords" DataKeyNames="Jr_Code" AllowFilteringByColumn="true">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="Problem_Desc" HeaderText="Justification" DataField="Problem_Desc" FilterControlWidth="100%" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                        </telerik:GridBoundColumn>
    ...
    <div class="x_panel" runat="server" id="divDetails" visible="false">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Noting - Details</h2>
            <ul class="nav navbar-right panel_toolbox">
                <li>
...
<%--                                    </telerik:RadPageView>
                ...
                <div class="row" style="padding: 5px;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <table style="border: none; width: 100%">
                            ...
                            <tr>
                                <td style="border: none; text-align: center; width: 16%">Requested By:
                                </td>
                                <td style="border: none; text-align: center; width: 16%">Checked By:
                                </td>
                                <td style="border: none; text-align: center; width: 16%">Assessed By:
                                </td>
                                <td style="border: none; text-align: center; width: 16%">Noted By:
                                </td>
    ...
    <asp:SqlDataSource ID="getRecords" runat="server"
        ...
        begin
                ...
                where A.Is_Submitted = 1 and A.Is_Checked = 1 
                and A.Is_Assessed = 1 and A.Is_Noted = 0
                and A.IsRejected = 0 and A.IsCancelled = 0
