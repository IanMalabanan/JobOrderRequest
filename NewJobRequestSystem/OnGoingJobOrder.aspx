<%@ Page Title="On-Going" Language="C#" MasterPageFile="~/JOMain.Master" AutoEventWireup="true" CodeBehind="OnGoingJobOrder.aspx.cs" Inherits="NewJobRequestSystem.OnGoingJobOrder" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_panel" runat="server" id="divRecords" visible="true">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Job Completion</h2>
        ...
        <div class="x_content">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gridRecords" runat="server" CssClass="RadGrid" GridLines="None"
                ...
                AllowAutomaticUpdates="True" DataSourceID="getRecords" EnableLinqExpressions="false">
                ...
                <MasterTableView DataSourceID="getRecords" DataKeyNames="Jr_Code" AllowFilteringByColumn="true">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn UniqueName="JONo" HeaderText="Job Order No" DataField="JRF_No" 
                        ...
                        <telerik:GridBoundColumn UniqueName="Dept_Desc" HeaderText="Department" DataField="Dept_Desc" FilterControlWidth="100%" 
                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn UniqueName="Sect_Desc" HeaderText="Section" DataField="Sect_Desc" FilterControlWidth="100%" 
                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn UniqueName="Partname" HeaderText="Item / Part Name" DataField="Partname" 
                            CurrentFilterFunction="Contains" FilterControlWidth="100%" AutoPostBackOnFilter="true" ShowFilterIcon="false">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn UniqueName="Problem_Desc" HeaderText="Justification" DataField="Problem_Desc" 
                         ...
                         <telerik:GridBoundColumn UniqueName="Incharge" HeaderText="Incharge" DataField="Incharge" 
                        ...
                        <telerik:GridCheckBoxColumn DataField="Counters" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                            HeaderText="Has Attachment?" UniqueName="Counters" AllowFiltering="false" Display="false" />

                        <telerik:GridTemplateColumn UniqueName="action" FilterControlWidth="100%" AllowFiltering="false">
                            <HeaderStyle Width="6%" />
                            <ItemTemplate>
    ...
    <div class="x_panel" runat="server" id="divDetails" visible="false">
        <div class="x_title">
            <h2 style="margin-top: 8px">Records For Job Completion - Details</h2>
            <ul class="nav navbar-right panel_toolbox">
                <li>
        ...
        <div class="x_content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3" runat="server" id="Div1">
                    <label class="docconlabels">Is Existing Jig?:</label>

                    <asp:TextBox ID="tbIsExistingJig" runat="server" ReadOnly="true" placeholder="Enter Text Here..." CssClass="form-control" Height="38px" TextMode="SingleLine"></asp:TextBox>

                </div>
                <div class="col-lg-6" runat="server" id="colAssessRemarks">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <asp:TextBox runat="server" ID="tbRemarks" ReadOnly="false" CssClass="form-control" Width="100%" TextMode="MultiLine" Height="150px" placeholder="Enter Text Here..."></asp:TextBox>
                ...
                <div class="col-lg-4">
                    <div style="margin-top: 50px">
                        ...
                        <telerik:RadDatePicker RenderMode="Lightweight" DateInput-ReadOnly="true" DateInput-DateFormat="dd/MMM/yyyy"
                            ID="dpAccomplish" Width="100%" Height="38px" runat="server" AutoPostBack="true">
            ...
            <div class="row">
                <div class="col-lg-12 aligncenter">
                    <asp:ImageButton ID="btnMarkAsFinished" CssClass="btnview" OnClientClick="return confirm('Mark As Finished?');"
                        runat="server" ImageUrl="images/completed.bmp" Width="150px" Height="50px" OnClick="btnaccept_Click"></asp:ImageButton>
                </div>
            </div>
        ...
        IF OBJECT_ID('TEMPDB.dbo.#tblCountAttachment') IS NOT NULL DROP TABLE #tblCountAttachment
                ...
                (JR_Code nvarchar(350) ,Counters int)
		            ...
		            begin               
                        ...
                        cast(Case when H.Counters is null then 0 else 1 end as bit) Counters
                        ...
                        and A.Is_Assessed = 1 and A.Is_Noted = 1 and A.Is_Approved = 1 and A.Is_JobAccepted = 1 
                        and A.IsCompleted = 0
                        and A.IsRejected = 0 and A.IsCancelled = 0 and Year(A.Request_Date) = @Year
