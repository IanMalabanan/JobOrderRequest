    ...
    public partial class Checker : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            btnShowReject.Attributes["onclick"] = String.Format("return ShowRejectForm('{0}','{1}','{2}');"
                , Request.QueryString["EmpID"].ToString().Trim(), Request.QueryString["RCode"].ToString().Trim(), "Checker");
            ...
            approverempid2 = Request.QueryString["EmpID"].ToString();
            ...
            foreach (var item in verifyRequest)
            {
                ...
                if ((Convert.ToBoolean(tblData.Is_Submitted) == true &&
                    ...
                    && (Convert.ToBoolean(tblData.IsRejected) == false || Convert.ToBoolean(tblData.IsCancelled) == false)) || (Convert.ToBoolean(tblData.Is_JobAccepted) == true ||
        ...
        protected void Approve(object sender, EventArgs e)
        {
            ...
            if (app != null)
            {
                ...
                app.Checker = approverfullname_fnamefirst.ToString();

                app.CheckerRemarks = "SIGNED";
        ...
        private void SendToRequestor()
        {
            ...
            body += "<br /><br />" + "Please be informed that your job order request has been checked.";
