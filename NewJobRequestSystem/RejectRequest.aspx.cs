...
namespace NewJobRequestSystem
{
    public partial class RejectRequest : System.Web.UI.Page
    {
        ...
        private void SendRejectedEmail()
        {
            ...
            body += "<br />" + "<br />" + "\"" + tbRejectReasons.Text + "\"";
        ...
        public void RejectByChecker_Attachment()
        {
            var app = dbContext.tblRequests.Where(x => x.JR_Code == jrcode).FirstOrDefault();
        ...
        {
            if (Request.QueryString["Action"].ToString().Trim() == "Checker")
            {
                RejectByChecker();
            }
            else if (Request.QueryString["Action"].ToString().Trim() == "Approver")
            {
                RejectByApprover();
            }
            else if (Request.QueryString["Action"].ToString().Trim() == "Noter")
            {
                RejectByNoter();
            }
            else if (Request.QueryString["Action"].ToString().Trim() == "Checker_Attachment")
            {
                RejectByChecker_Attachment();
            }
